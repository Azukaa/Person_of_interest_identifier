...
### After running the function on various classififcation algorithms and tuning it on various parameters, I found out that the best classifier
### is the Decision tree classifier. It was also tuned to various parameters and achieved an accuracy of 0.9285, a precision of 1.0 and a recall of 0.5.
...
#     #               'n_estimators': [2, 3, 4, 5, 6, 7,10,20,30]}
#     # svm = SVC()
#     # parameters3 = {'kernel': ['rbf'],
#     #               'C': [1, 10, 100, 1000, 10000, 100000]}
#     clf = GridSearchCV(dt, parameters1)
...
#             count1+=1
#     #print(count1)
#     clf_list.append([accuracy,precision,recall,cm,n_features,scores,count,count1, clf])
#
#     return clf_list[::-1][0]
#
# clf_list2 = []
...
# clf = order_clf_list[len(order_clf_list) - 1][8]
# print(clf)
#
# number_of_features = order_clf_list[len(order_clf_list) - 1][4]
# print(number_of_features)
# print("confusion matrix: ")
# cm = order_clf_list[len(order_clf_list) - 1][4]
# print(cm)
# print('Features and scores: ')
# score_list = order_clf_list[len(order_clf_list) - 1][5]
# print(score_list)
